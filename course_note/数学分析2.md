...
\\
&\texttt{back substitution, re-evaluate the area}\\
\mathrm{d}S
&=\left\vert \left\vert
  \overrightarrow{r_u}
  \times
...
&=\left\vert \left\vert
  ...
  (p_u q_v-q_u p_v)
  \left[
  \left(u_p\mathrm{d}p + u_q\mathrm{d}q\right)
  \wedge
  \left(v_p\mathrm{d}p + v_q\mathrm{d}q\right)
  \right]\\
&=\left\vert \left\vert
   \vec d_p\times \vec d_q
  \right\vert \right\vert
  (p_u q_v-q_u p_v)
  (u_p v_q \mathrm{d}p\wedge \mathrm{d}q
  +u_q v_p \mathrm{d}q\wedge \mathrm{d}p
  )\\
&=\left\vert \left\vert
   \vec d_p\times \vec d_q
  \right\vert \right\vert
  (p_u q_v-q_u p_v)
  (u_p v_q -u_q v_p)
  \mathrm{d}q\wedge \mathrm{d}p\\
&=\left\vert \left\vert
   \vec d_p\times \vec d_q
  \right\vert \right\vert
  \dfrac{\partial (p,q)}{\partial (u,v)}\dfrac{\partial(u,v)}{\partial (p,q)}
  \mathrm{d}q\wedge \mathrm{d}p\\
&=\left\vert \left\vert
   \vec d_p\times \vec d_q
  \right\vert \right\vert
