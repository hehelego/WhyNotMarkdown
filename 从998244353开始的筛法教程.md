...
f(p^c)(1+\sum_{\begin{subarray}{l} mp(x)> p\\2\leq x \leq \lfloor\frac{n}{p^c}\rfloor\end{subarray}}f(x))+\sum_{\begin{subarray}{l} p\in prime\\ \sqrt n < p \leq n\end{subarray}}f(p)\\
&=\sum_{\begin{subarray}{l} p^c \leq n\\p\in prime\\ m< p \leq \sqrt n\end{subarray}}f(p^c)(1+g_{\lfloor\frac{n}{p^c}\rfloor,p})+h_n-h_{\sqrt n}
\end{aligned}
$$
