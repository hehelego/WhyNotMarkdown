...
f(S)=\sum_{T\subseteq S}g(T)\alpha(|T|)
=\sum_{T\subseteq S}\alpha(|T|)\sum_{R\subseteq T}f(R)
=\sum_{R\subseteq S}f(R)\sum_{R\subseteq T\subseteq S}\alpha(|T|)\\
let\,(l,r)=(|R|,|S|)\\
=\sum_{R\subseteq S}f(R)\sum_{l\leq i\leq r}\binom{r-l}{i-l}\alpha(i)\\

we\,expect\,to\,have\quad \sum_{l\leq i\leq r}\binom{r-l}{i-l}\alpha(i)=[l=r]\\
\sum_{i=0}^{r-l}\binom{r-l}{i}\alpha(i+l)=(1-1)^{r-l}=\sum_{i=0}^{r-l}\binom{r-l}{i}(-1)^i\\
so\, \alpha(i)=(-1)^{i-l}=(-1)^{i-|S|}\\
